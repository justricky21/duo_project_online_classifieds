...
public class Seeds {
    ...
    public static void seedData() {
        ...
        User user1 = new User("Alden", "Henderson", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "ahenderson", "055 9234 5710", "habitant.morbi@Quisqueaclibero.org");
        User user2 = new User("Dana", "Johns", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "djohns", "055 9234 5710", "odio.a.purus@amet.net");
        User user3 = new User("Kyle", "Hardy", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "khardy", "055 9234 5710", "non.enim@leoin.edu");
        User user4 = new User("Christopher", "Dixon", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "cdixon", "055 9234 5710", "in@elitdictumeu.co.uk");
        User user5 = new User("Zorita", "Good", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "zgood", "055 9234 5710", "Quisque.porttitor.eros@lacus.org");
        User user6 = new User("Kermit", "Cardenas", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "kcardenas", "055 9234 5710", "non@Etiambibendum.org<");
        User user7 = new User("Omar", "Diaz", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "odiaz", "055 9234 5710", "mattis.velit.justo@leo.co.uk");
        User user8 = new User("Rudyard", "Harris", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "rharris", "055 9234 5710", "elit.dictum@duiFuscealiquam.co.uk");
        User user9 = new User("Quentin", "Galloway", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "qgalloway", "055 9234 5710", "ullamcorper.Duis@loremtristiquealiquet.ca");
        User user10 = new User("Uma", "Logan", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "ulogan", "055 9234 5710", "at@Suspendissetristique.org");
        User user11 = new User("Debra", "Cobb", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "dcobb", "055 9234 5710", "at@blanditatnisi.ca");
        User user12 = new User("Jared", "Owen", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "jowen", "055 9234 5710", "ut@arcueu.com");
        User user13 = new User("Bruce", "Mathews", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "bmatthews", "055 9234 5710", "facilisi.Sed@Proinvelit.ca");
        User user14 = new User("Mollie", "Schultz", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "mschultz", "055 9234 5710", "sem.magna@atsemmolestie.net");
        User user15 = new User("Fredericka", "Ware", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "fware", "055 9234 5710", "risus.Morbi@tinciduntDonecvitae.edu");
        User user16 = new User("Orlando", "Jacobson", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "ojacobson", "055 9234 5710", "in@erat.net");
        User user17 = new User("Kasper", "Monroe", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "kmonroe", "055 9234 5710", "mauris.sagittis.placerat@Nulla.edu");
        User user18 = new User("Geoffrey", "Acosta", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "gacosta", "055 9234 5710", "dolor@acliberonec.edu");
        User user19 = new User("Mannix", "Mccall", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "mmcall", "055 9234 5710", "ac.feugiat@sedpedeCum.edu");
        User user20 = new User("Macy", "Mcbride", "570-4313 Etiam Rd.", "", "Bromley", "Kent", "FV5B 3XN", "mmcbride", "055 9234 5710", "at.libero@ametdapibus.org");
        DBHelper.save(user1);
        DBHelper.save(user2);
        DBHelper.save(user3);
        DBHelper.save(user4);
